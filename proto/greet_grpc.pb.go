...
type GreetServiceClient interface {
	...
	SayHelloBidirectionsStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirectionsStreamingClient, error)
}
...
func (c *greetServiceClient) SayHelloBidirectionsStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirectionsStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet_service.GreetService/SayHelloBidirectionsStreaming", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBidirectionsStreamingClient{stream}
	return x, nil
}

type GreetService_SayHelloBidirectionsStreamingClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBidirectionsStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBidirectionsStreamingClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirectionsStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloBidirectionsStreaming(GreetService_SayHelloBidirectionsStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloBidirectionsStreaming(GreetService_SayHelloBidirectionsStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBidirectionsStreaming not implemented")
}
...
func _GreetService_SayHelloBidirectionsStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBidirectionsStreaming(&greetServiceSayHelloBidirectionsStreamingServer{stream})
}

type GreetService_SayHelloBidirectionsStreamingServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBidirectionsStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBidirectionsStreamingServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirectionsStreamingServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBidirectionsStreaming",
			Handler:       _GreetService_SayHelloBidirectionsStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
